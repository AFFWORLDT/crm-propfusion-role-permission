...
import usePropertySearch from "../features/properties/usePropertySearch";

function FormInputPropertySearch({
    control,
    registerName,
    ...
    isMulti = false,
    label = "",
    labelPosition = "left", // Add labelPosition prop with default "top"
}) {
    ...
    const { properties, isLoading } = usePropertySearch(debouncedSearchTerm);
...
export default FormInputPropertySearch;
