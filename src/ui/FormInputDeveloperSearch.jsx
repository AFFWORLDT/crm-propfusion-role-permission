...
import useDeveloperSearch from "../features/properties/useDeveloperSearch";

function FormInputDeveloperSearch({
    control,
    registerName,
    ...
    const { developers, isLoading } = useDeveloperSearch(debouncedSearchTerm);
...
export default FormInputDeveloperSearch;
