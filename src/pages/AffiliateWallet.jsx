                ...
                <div className="summary-cards">
                    ...
                    <div className="summary-card total-affiliates">
                        ...
                        <div className="card-content">
                            ...
                            <p className="amount">
                                {earningsData?.total_affiliates || 0}
                            </p>
                    ...
                    <div className="summary-card total-referred">
                        ...
                        <div className="card-content">
                            ...
                            <p className="amount">
                                {earningsData?.total_referred_agents || 0}
                            </p>
                ...
                <div className="earnings-section">
                    <div className="section-header">
                        ...
                        <div className="section-subtitle">
                            Track your referral success and see who you&apos;ve
                            helped join the team
                        </div>
                    </div>
                    <div className="earnings-list">
                        {earningsData?.earnings?.map((earning, index) => (
                            <div
                                key={earning.agent_id || index}
                            ...
                            >
                                ...
                                {earning.referred_agents &&
                                    earning.referred_agents.length > 0 && (
                                        <div className="referred-agents">
                                            ...
                                            <div className="agents-grid">
                                                {earning.referred_agents.map(
                                                    (agent, agentIndex) => (
                                                        <div
                                                            key={agent.id}
                                                            className="referred-agent-card"
                                                        >
                                                            ...
                                                            <div className="agent-info-small">
                                                                ...
                                                                <div className="agent-details-small">
                                                                    <h5 className="agent-name-small">
                                                                        {
                                                                            agent.name
                                                                        }
                                                                    </h5>
                                                                    <p className="agent-email-small">
                                                                        {
                                                                            agent.email
                                                                        }
                                                                    </p>
                ...
                {error && earningsData && (
                    <div className="warning-banner">
                        ...
                        <div className="warning-content">
                            <strong>API Error:</strong> Using cached data.{" "}
                            {error}
                        </div>
                        <button
                            onClick={fetchEarningsData}
                            className="warning-refresh-btn"
                        >
