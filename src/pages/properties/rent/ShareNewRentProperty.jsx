        ...
        <section id={ID} className={styles.shareListing}>
            {isPdf && (
                <BtnCreatePdf
                    ...
                    fileName={
                        property?.title
                            ? `${property.title.replace(/\s+/g, '_')}_RENT.pdf`
                            : 'Property_Rent.pdf'
                    }
                />
            )}
            ...
            <div className={styles.shareListingContent}>
                ...
                <div className={styles.listingHero}>
                    ...
                    <div className={styles.listingHeroContent}>
                        ...
                        <p className={styles.price}>
                            ...
                            <span>{currency} / {property?.priceType}</span>
                        </p>
                        <ul>
                            <li>
                                <div>
                ...
                <div className={styles.listingInfo}>
                    <ul>
                        ...
                        <li>
                            <span>
                                <img src="/share-page/call.png" alt="Deposit" />
                                Deposit: 
                            </span>
                            <span>
                                {property?.deposit
                                    ? `${currency} ${formatNum(convertPrice(property?.deposit))}`
                                    : "N/A"}
                            </span>
                        </li>
                        <li>
                            <span>
                                <img src="/share-page/call.png" alt="Cheques" />
                                Cheques: 
                            </span>
