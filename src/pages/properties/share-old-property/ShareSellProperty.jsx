                ...
                <div className={styles.listingInfo}>
                    <ul>
                        <li>
                            ...
                            <span>
                                {propertyData[0].sellParam.completionStatus ||
                                    "N/A"}
                            </span>
                        </li>
                        <li>
                            <span>Size: </span>
                            <span>{propertyData[0].size || "N/A"} sq.ft</span>
                        </li>
                        <li>
                            <span>Bathrooms: </span>
                            <span>
                                {propertyData[0].sellParam.bathrooms || "N/A"}
                            </span>
                        </li>
                        <li>
                            <span>Total Floor: </span>
                            <span>
                                {propertyData[0].sellParam.totalFloor || "N/A"}
                            </span>
                        </li>
                        <li>
                            <span>Build Year: </span>
                            <span>
                                {propertyData[0].sellParam.buildYear || "N/A"}
                            </span>
                        </li>
                        <li>
                            <span>Occupancy: </span>
                            <span>
                                {propertyData[0].sellParam.occupancy || "N/A"}
                            </span>
                        </li>
                        <li>
                            <span>Parking: </span>
                            <span>
                                {propertyData[0].sellParam.parking || "N/A"}
                            </span>
                        </li>
                        <li>
                            <span>Furniture: </span>
                        ...
                        <li>
                            ...
                            <span>
                                {propertyData[0].sellParam.serviceCharge ||
                                    "N/A"}
                            </span>
                        </li>
                        <li>
                            <span>AC Charge: </span>
                            <span>
                                {propertyData[0].sellParam.acCharge || "N/A"}
                            </span>
                        </li>
                        <li>
                            <span>Mortgage: </span>
                            <span>
                                {propertyData[0].sellParam.hasMortgage || "N/A"}
                            </span>
                        </li>
                    </ul>
                </div>
...
export default ShareSellProperty;
